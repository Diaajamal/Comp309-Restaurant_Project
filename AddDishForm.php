...
<div class="limiter">
    <div class="container-login100">
        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
            <form class="login100-form validate-form" action="addDish.php" method="POST">
                ...
                <div class="wrap-input100 validate-input" data-validate="Name is required">
                    ...
                    <input class="input100" type="text" name="dishName" id="dishName" placeholder="name">
                    <span class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input" data-validate="dishPrice is required">
                    <span class="label-input100">price</span>
                    <input class="input100" type="text" name="dishPrice" id="dishPrice" placeholder="price">
                    <span class="focus-input100"></span>
                </div>
